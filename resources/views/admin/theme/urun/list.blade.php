                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                       <a href="{{ url($url.'/image-settings') }}" class="btn btn-sm btn-warning"><i data-feather="settings"></i> Ayarlar</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                            ...
                                            <tbody id="sortable" data-table="urun">
                                                @if ($list) 
                                                    @foreach($list as $item)
                                                    <tr id="list-{{ $item->id }}">
                                                        <td><img class="border" height="50" src="{{ asset('uploads/' . $item->image) }}" alt="{{ $item->baslik }}"></td>
                                                        <td>{{ $item->baslik }}</td>
                                                        <td>{{ $item->slug }}</td>
