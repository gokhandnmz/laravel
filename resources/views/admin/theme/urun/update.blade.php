                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane show active" id="icerik">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea name="data[aciklama]" id="aciklama" class="form-control" required>{{ $item->aciklama }}</textarea>
                                                            </div>
        
                                                            <div class="mb-3">
                                                                <label for="editor" class="form-label">İçerik</label>
                                                                <textarea name="data[icerik]" id="editor" class="form-control">{{ $item->icerik }}</textarea>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="fiyat" class="form-label">Fiyat</label>
                                                                <input type="text" name="data[fiyat]" id="fiyat" class="form-control" placeholder="Fiyat" value="{{ $item->fiyat }}">
                                                            </div>
                                                            <div class="mb-3">
                                                        ...
                                                        <div class="tab-pane" id="seo">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="data[seo_title]" id="seo_baslik" class="form-control seo-title" placeholder="Seo Başlık" maxlength="64" value="{{ $item->seo_title }}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="seoaciklama" class="form-label">Seo Açıklama</label>
                                                                <textarea name="data[seo_description]" id="seoaciklama" rows="2" class="form-control seo-description" maxlength="300">{{ $item->seo_description }}</textarea>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="seoanahtarkelimeler" class="form-label">Seo Keywords</label>
                                                                <input type="text" name="data[seo_keywords]" id="seoanahtarkelimeler" class="form-control seo-keywords" placeholder="Seo Anahtar Kelimeler" maxlength="120" value="{{ $item->seo_keywords }}">
                                                            </div>
                                                        </div>
